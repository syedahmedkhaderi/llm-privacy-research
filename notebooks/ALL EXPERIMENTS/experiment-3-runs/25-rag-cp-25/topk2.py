...
Original file is located at
    https://colab.research.google.com/drive/1gtA4li8owf0H5R5WiUAmWNDUm_cXM9N-
...
def run_dea_experiment(
    ...
    **kwargs
    ...
    for canary_type in tqdm(canary_types, desc="Canary types"):
        ...
        for rep in canary_repetitions:
            ...
            pbar = tqdm(
                total=num_canaries,
                desc=f"Canaries | {canary_type} | rep={rep}",
                file=sys.stdout,
                ncols=80
            )
